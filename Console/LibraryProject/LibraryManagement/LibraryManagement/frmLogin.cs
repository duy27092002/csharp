...
namespace LibraryManagement
{
    public partial class frmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (dao.CheckLogin(getUsername, getPwd, getPhone))
            {
                UserDAO.userId = dao.GetUserIdAfterLogin(getUsername, getPwd, getPhone);

                // mở phần mềm
                frmLibraryManagement frm = new frmLibraryManagement();
                this.Hide();
                frm.ShowDialog();
                this.Show();
            }
